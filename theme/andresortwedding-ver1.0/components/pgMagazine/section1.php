...
?>
<section class="pg_magazine_section" id="section1">
  <div class="pg_magazine_section_ttl" style="background-image: url(<?php echo esc_url(get_theme_file_uri('assets/images/magazine/section1/list_head.jpg')); ?>)">
    <h3>結婚式準備・基礎知識</h3>
  </div>
