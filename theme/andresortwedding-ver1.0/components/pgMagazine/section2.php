...
?>
<section class="pg_magazine_section" id="section2">
  <div class="pg_magazine_section_ttl" style="background-image: url(<?php echo esc_url(get_theme_file_uri('assets/images/magazine/section2/list_head.jpg')); ?>)">
    <h3>エリア・式場選び</h3>
  </div>
