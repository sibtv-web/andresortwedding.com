...
?>
<section class="pg_magazine_section" id="section4">
  <div class="pg_magazine_section_ttl" style="background-image: url(<?php echo esc_url(get_theme_file_uri('assets/images/magazine/section4/list_head.jpg')); ?>)">
    <h3>フォトウェディング</h3>
  </div>
