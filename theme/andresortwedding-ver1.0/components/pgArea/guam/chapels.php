      ...
      <ul class="pgarea_chapels_list cls-big">
        <li class="pgarea_chapels_cmn fade-anime" data-fade="fade-up-cont">
          ...
          <div class="pgarea_chapels_cmn_tb">
            <dl><dt>収容人数</dt><dd>2～45名</dd></dl>
            <dl><dt>所在地</dt><dd>ハイアット リージェンシー グアム内</dd></dl>
        ...
        <li class="pgarea_chapels_cmn fade-anime" data-fade="fade-up-cont">
          ...
          <div class="pgarea_chapels_cmn_tb">
            <dl><dt>収容人数</dt><dd>2～16名</dd></dl>
            <dl><dt>所在地</dt><dd>ザ ツバキタワーホテル内</dd></dl>
            <dl><dt>運営会社</dt><dd>アールイズ・ウエディング</dd></dl>
          </div>
        ...
        <div class="splide__track">
          <ul class="pgarea_chapels_list splide__list cls-slider">
            <li class="pgarea_chapels_cmn splide__slide fade-anime" data-fade="fade-up-cont">
              ...
              <div class="pgarea_chapels_cmn_tb">
                <dl><dt>収容人数</dt><dd>2～70名</dd></dl>
                <dl><dt>所在地</dt><dd>ホテル・ニッコー・グアム内</dd></dl>
                <dl><dt>運営会社</dt><dd>アールイズ・ウエディング</dd></dl>
              </div>
            ...
            <li class="pgarea_chapels_cmn splide__slide fade-anime" data-fade="fade-up-cont">
              ...
              <div class="pgarea_chapels_cmn_tb">
                ...
                <dl><dt>所在地</dt><dd>リーガロイヤル・ラグーナ・グアム・リゾート内</dd></dl>
                <dl><dt>運営会社</dt><dd>アールイズ・ウエディング</dd></dl>
              </div>
        ...
        <div class="splide__track">
          <ul class="pgarea_chapels_list splide__list cls-slider">
            ...
            <li class="pgarea_chapels_cmn splide__slide fade-anime" data-fade="fade-up-cont">
              ...
              <small class="pgarea_chapels_cmn_comp">©Petit Wedding </small>

              <div class="pgarea_chapels_cmn_tb">
                <dl><dt>収容人数</dt><dd>50名</dd></dl>
                <dl><dt>所在地</dt><dd>ロッテグアムホテル内</dd></dl>
                <dl><dt>運営会社</dt><dd>小さな結婚式</dd></dl>
              </div>
