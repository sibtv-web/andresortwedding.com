<section id="voice" class="voice bg-wht-1">
  <div class="voice__inner section__inner">
    ...
    <div class="voice__comment flex fade-anime" data-fade="fade-up-cont">
      <?php 
        $data = [
          '最初は「準備が大変そう…費用が高そう」と、<br/>パートナーと意見が合わないことも。<br/>でも実際は<span class="ft-blu-1">想像以上に準備がスムーズ。</span><br/><span class="ft-blu-1">新婚旅行も一緒に楽しめて</span>最高の思い出になりました。',
          'チャペルの扉が開いた瞬間、<br/><span class="ft-blu-1">海の青さが一気に広がって</span>、思わず涙が出ました。<br/>緊張が消えて<span class="ft-blu-1">「人生で今が一番幸せ」って思いました。<span class="ft-blu-1">',
          '少人数だったので、<span class="ft-blu-1">大切な人たちの表情が<br/>一人ひとりちゃんと見えて</span>、みんなの祝福がすごく温かかった。<br/>家族旅行も兼ねた親孝行ができたのも良かったです。',
          '<span class="ft-blu-1">夕日のビーチフォト</span>は、結婚式で一番の宝物です。<br/>妥協せず、<span class="ft-blu-1">思い切ってリゾートにして<br/>本当に良かった</span>と思いました。',
        ];
        $count = 0;
